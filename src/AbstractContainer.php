...
abstract class AbstractContainer implements ContainerInterface
{
    ...
    /**
     * Creates new instance of the class definition with dependencies resolved
     * @param array $definition
     * @return object the newly built instance of the specified class
     * @throws CircularReferenceException
     * @throws InvalidConfigException
     * @throws NotFoundException if there is nothing registered with alias or interface specified
     * @throws NotInstantiableException
     */
    protected function build($id, array $config = [])
    {

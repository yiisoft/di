...
class DecoratorTest extends TestCase
{
    ...
    public function testAddDecoratorAsClassName()
    {
        ...
        $this->assertEquals(self::EXPECTED_CAR_COLOR, $car->color, 'CarColorDecorator should have set car color');
    }
    ...
    public function testAddDecoratorAsCallable()
    {
        ...
        $this->assertEquals(self::EXPECTED_CAR_COLOR, $car->color, 'callable decorator should have set car color');
    }

    public function testAddDecoratorWithUnsupportedType()
    {
        $this->expectException(InvalidConfigException::class);
        $this->expectExceptionMessage('Decorator should be a callable or implement ' . Decorator::class);
    ...
    public function testAddSeveralDecorators()
    {
        ...
        $this->assertEquals(self::EXPECTED_CAR_COLOR, $car->color, 'CarColorDecorator should have set car color');
        $this->assertEquals(self::EXPECTED_CAR_OWNER, $car->owner, 'CarOwnerDecorator should have set car owner');
    }

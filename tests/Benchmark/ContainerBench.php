...
class ContainerBench
{
    ...
    public function before(): void
    {
        ...
        $this->composite->attach(new Container(ContainerConfig::create($definitions2)));
        $this->composite->attach(new Container(ContainerConfig::create($definitions3)));
        $this->composite->attach(new Container(ContainerConfig::create($definitions2)));
        $this->composite->attach(new Container(ContainerConfig::create($definitions3)));
        $this->composite->attach(new Container(ContainerConfig::create($definitions2)));
        $this->composite->attach(new Container(ContainerConfig::create($definitions3)));
    ...
    public function benchConstruct(): void
    {
        ...
        $container = new Container(ContainerConfig::create($definitions));
    }
